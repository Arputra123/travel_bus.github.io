...
<head>
    ...
    <!--=== Favicon ===-->
    <link rel="shortcut icon" href="<?= base_url() ?>assets/assets_shop/img/logodash.ico" type="image/x-icon" />
    ...
    <div class="preloader">
        <div class="preloader-spinner">
            <div class="loader-content">
                <img src="<?= base_url() ?>assets/assets_shop/img/loader1.gif" alt="JSOFT">
            </div>
        </div>
    </div>
    <!--== Preloader Area End ==-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 text-left">
                        <i class="fa fa-instagram"></i> arputratour
                    </div>
                    <!--== Single HeaderTop End ==-->

                    <!--== Single HeaderTop Start ==-->
                    <div class="col-lg-2 text-center">
                        <i class="fa fa-whatsapp"></i> 0852-1098-3458
                    </div>
                    <!--== Single HeaderTop End ==-->
                    ...
                    <!--== Single HeaderTop Start ==-->
                    <div class="col-lg-2 text-center">
                        <i class="fa fa-map-marker"></i> 42184, Kab.Serang
                    </div>
                    <!--== Single HeaderTop End ==-->
                    ...
                    <div class="header-social-icons">
                        <a href="https://www.instagram.com/arputratour/"><i class="fa fa-instagram"></i></a>
                        <a href="https://api.whatsapp.com/send?phone=+6285210983458"><i class="fa fa-whatsapp"></i></a>
                    </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <a href="<?= base_url('customer/dashboard') ?>" class="logo">
                            <img src="<?= base_url('assets/assets_stisla') ?>/assets/img/logodash.png" width="50" alt="JSOFT">
                        </a>
                    </div>
                    <!--== Logo End ==-->
                        ...
                        <nav class="mainmenu alignright">
                            <ul>
                                ...
                                <?php if (isset($_SESSION['level']) == 2) { ?>
                                    <li><a href="javascript:;"><i class="fa fa-user"></i> Welcome | <?= $_SESSION['nama']; ?></a>
                                        <ul>
