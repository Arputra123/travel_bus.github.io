								...
								<div class="card">
									<div class="card-header" id="headingOne">
										<h5 class="mb-0"><button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
												<span>Bagaimana cara menyewa mobil di Arputra Travel?</span>
								...
								<div class="card">
									<div class="card-header" id="headingTwo">
										<h5 class="mb-0"><button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
												<span>Bagaimana cara menghubungi Admin di Arputra Travel?</span>
												<i class="fa fa-angle-down"></i>
												<i class="fa fa-angle-up"></i>
											</button></h5>
									</div>
								...
								<div class="card">
									...
									<div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordion_2">
										<div class="card-body">
											...
											<br>
											Bank: <img src="<?= base_url('assets/assets_shop/img/logobca.png'); ?>" width="80px" height="30px">
											<br>
											No. Rekening: 4921354392
											<br>
											Penerima: ALLFIAN RAHMA PUTRA
											<br>
											<br>
