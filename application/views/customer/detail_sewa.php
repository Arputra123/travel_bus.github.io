				...
				<div class="contact-form">
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<b>*Silahkan transfer Total Biaya Sewa ke 4921354392 Bank BCA a/n ALLFIAN RAHMA PUTRA maksimal tanggal <?= $batas_bayar ?>. <br>
								Untuk konfirmasi pesanan silahkan ke halaman selanjutnya!</b>
							<br>

							<a href="<?= base_url('customer/rental/riwayat_sewa') ?>" class="rent-btn"><i class="fa fa-tag"></i>LANJUTKAN TRANSAKSI</a>
